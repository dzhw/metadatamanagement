...
module.exports = function(grunt) {
  ...
  grunt
      .registerTask(
          ...
          function(target) {
            grunt.log
                .warn('The `server` task has been deprecated.' +
                    ' Use `grunt serve` to start a server.');
            grunt.task.run([target ? ('serve:' + target) : 'serve']);
          });

  grunt.registerTask('test', ['clean:server', 'wiredep:test', 'ngconstant:dev',
  ...
  grunt.registerTask('build', ['clean:dist', 'wiredep:app', 'ngconstant:prod',
      ...
      'autoprefixer', 'uglify', 'rev', 'usemin', 'htmlmin', 'jshint', 'jscs']);
