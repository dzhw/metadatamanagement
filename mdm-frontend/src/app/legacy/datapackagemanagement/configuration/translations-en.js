    ...
    var translations = {
      ...
      'data-package-management': {
        ...
        'detail': {
          ...
          'embargo-warning': {
            'title-order-view': 'Datenpaket unterliegt einem Embargo durch die Datengeber:innen',
            'title-provider-view': 'Datenpaket unterliegt einem Embargo durch die Datengeber:innen',
            ...
            'contnet-order-view-expired': 'This data package is currently not yet available for order as it is still being prepared. Contact <a href="mailto:userservice@dzhw.eu">userservice@dzhw.eu</a> if you wish to receive information regarding the release date of the data package.',
            'content-provider-view': 'This data package is subject to an embargo until {{ date }}. The final release can only take place after this date. You can still edit the data package.',
            'content-provider-view-expired': 'This data package is currently preliminarily released. You can still edit the data package.'
          },
          'attachments': {
