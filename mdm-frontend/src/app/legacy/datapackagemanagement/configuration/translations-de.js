    ...
    var translations = {
      ...
      'data-package-management': {
        ...
        'detail': {
          ...
          'elsst-info': 'Die Schlagwörter, auf die hier verwiesen wird, stammen aus dem European Language Social Science Thesaurus (ELSST) - CESSDA and Service Providers. The European Language Social Science Thesaurus (ELSST). ELSST ist ein breit angelegter, mehrsprachiger Thesaurus für die Sozialwissenschaften. Er ist Eigentum des Consortium of European Social Science Data Archives (CESSDA) und seiner nationalen Dienstleister und wird von diesen herausgegeben. Der Thesaurus besteht aus über 3.400 Konzepten und deckt die wichtigsten sozialwissenschaftlichen Disziplinen ab: Politik, Soziologie, Wirtschaft, Bildung, Recht, Kriminalität, Demografie, Gesundheit, Beschäftigung, Informations- und Kommunikationstechnologie sowie Umweltwissenschaften. Der ELSST wird regelmäßigen Aktualisierungen unterzogen, sodass bestimmte Begriffe mit der Zeit veralten können. Siehe für weitere Informationen zu den jeweiligen Releases: <a href="https://elsst.cessda.eu/releases">https://elsst.cessda.eu/releases</a> und die jeweiligen Detailseiten der Begriffe. Der ELSST ist unter einer Creative Commons Attribution-ShareAlike 4.0 International License (<a href="http://creativecommons.org/licenses/by-sa/4.0/">http://creativecommons.org/licenses/by-sa/4.0/</a>) lizenziert. Weitere Informationen: <a href="https://elsst.cessda.eu/">https://elsst.cessda.eu/</a>'
        },
        'log-messages': {
          'data-package': {
