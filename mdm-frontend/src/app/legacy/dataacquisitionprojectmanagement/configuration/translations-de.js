      ...
      'data-acquisition-project-management': {
        ...
        'log-messages': {
          'data-acquisition-project': {
            ...
            'dara-released-not-successfully': 'Die Daten des Projektes "{{ id }}" können nicht veröffentlicht werden. Der da|ra-Service zur Registrierung der doi ist aktuell nicht verfügbar. Kontaktieren Sie den Administrator und versuchen Sie es später erneut.',
