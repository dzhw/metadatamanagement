    ...
    var translations = {
      ...
      'analysis-package-management': {
        'detail': {
          ...
          'tag-tooltip': 'Klicken, um Analysepakete mit diesem Schlagwort zu suchen.',
          'tagElsst-tooltip': 'Klicken, um Analysepakete mit diesem ELSST-Schlagwort zu suchen.',
        ...
        'edit': {
          ...
          'all-analysis-packages-deleted-toast': 'Das Analysepaket des Datenaufnahmeprojekts "{{id}}" wurde gelöscht.',
          ...
          'label': {
            ...
            'last-name': 'Nachname',
            'tags': 'Schlagwörter zum Analysepaket',
            'tagsElsst': 'ELSST-Schlagwörter zum Analysepaket',
