        ...
        var translations = {
            ...
            'embargo-warning': {
                ...
                'analysis-package': {
                    ...
                    'content-provider-view': 'This analysis package is subject to an embargo until {{ date }}. Publication can only take place after this date. You can still edit the analysis package',
                    'content-provider-view-expired': 'This analysis package is currently preliminarily released. You can edit the analysis package until the final release.'
                }
              }
        }
