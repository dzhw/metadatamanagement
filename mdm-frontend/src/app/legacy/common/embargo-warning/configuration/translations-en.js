        ...
        var translations = {
            ...
            'embargo-warning': {
                ...
                'analysis-package': {
                    ...
                    'content-order-view': 'This analysis package is currently not yet available for order as it is subject to an embargo until {{ date }}. Publication can only take place after this date. <b>Please note that the embargo date does not necessarily correspond to the expected release date</b>, please contact <a href="mailto:userservice@dzhw.eu">userservice@dzhw.eu</a> if you wish to receive information regarding the release date of the analysis package. As soon as the analysis package is released, you can put them in the shopping cart at this point.',
