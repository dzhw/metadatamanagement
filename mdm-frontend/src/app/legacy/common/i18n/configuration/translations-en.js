        ...
        'institutions':{
          'edit': {
            ...
            'ror-search': {
              ...
              'results-found-text': 'The following entries have been found at ROR.org (search parameters: Name={{ name }}):',
              'no-results-found-text': 'No entries found at ROR.org (search parameters: Name={{ name }}).',
              'select': 'Select',
