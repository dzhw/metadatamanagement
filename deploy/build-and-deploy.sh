...
if [ "${TRAVIS_EVENT_TYPE}" = "cron" ]; then
  ...
  ROBOT_CHROME="robot -P ./src/test/robotframework/libs -d target/test/robotframework/logs/chrome --console dotted -v USE_SAUCELABS:TRUE -v BROWSER:chrome --exclude smoketest --exclude firefoxonly ./src/test/robotframework"
  ROBOT_FIREFOX="robot -P ./src/test/robotframework/libs -d target/test/robotframework/logs/firefox --console dotted -v USE_SAUCELABS:TRUE -v BROWSER:firefox --exclude smoketest --exclude chromeonly ./src/test/robotframework"
  ROBOT_IE11="robot -P ./src/test/robotframework/libs -d target/test/robotframework/logs/ie11 --console dotted -v USE_SAUCELABS:TRUE -v BROWSER:ie --exclude smoketest --exclude firefoxonly --exclude chromeonly ./src/test/robotframework"
  ROBOT_EDGE="robot -P ./src/test/robotframework/libs -d target/test/robotframework/logs/edge --console dotted -v USE_SAUCELABS:TRUE -v BROWSER:edge --exclude smoketest --exclude firefoxonly --exclude chromeonly ./src/test/robotframework"
