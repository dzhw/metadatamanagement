...
#
html_theme_options = {
    'canonical_url': 'https://metadatamanagement.readthedocs.io/de/latest/',
    'analytics_id': '',
    'logo_only': False,
...
htmlhelp_basename = 'MetaDataManagementdoc'
...
man_pages = [
    (master_doc, 'metadatamanagement', 'MetaDataManagement Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MetaDataManagement', 'MetaDataManagement Documentation',
     author, 'MetaDataManagement', 'One line description of project.',
     'Miscellaneous'),
]
