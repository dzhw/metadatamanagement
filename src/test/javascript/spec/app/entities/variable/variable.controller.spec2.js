...
describe('Controllers Tests ', function () {
  var $scope, createController, Variable, AlertService, VariableSearchDao, MockEntity, $q, $location;
  var data = {
    hits: {
      total: 1,
      max_score: 1,
  ...
  beforeEach(function() {
    inject(function($controller, _$rootScope_, _AlertService_, _$q_, _$location_) {
   ...
   describe('VariablesController',function(){
     ...
     it('should delete variable with id 564dd567ce1a0ed573dbda51',function(){
        $scope.delete();
        expect($scope.variable._id).toEqual('564dd567ce1a0ed573dbda51');
     });
     ...
     it('should call $scope.search() on variable.created event',function(){
       spyOn($scope,'search').and.callThrough();
       $scope.$broadcast('variable.created');
       expect($scope.search).toHaveBeenCalled();
     });
     it('should call $scope.search() on variable.updated event',function(){
       spyOn($scope,'search').and.callThrough();
