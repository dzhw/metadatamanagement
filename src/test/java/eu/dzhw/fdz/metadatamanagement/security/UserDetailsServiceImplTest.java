 ...
 *
 */
public class UserDetailsServiceImplTest extends BasicTest {
  ...
  public void testLoadUserByUsername() {
    // Arrange
    Set<ConstraintViolation<User>> constrains = this.testUtils.checkAndPrintValidation(this.user, this.validator);
