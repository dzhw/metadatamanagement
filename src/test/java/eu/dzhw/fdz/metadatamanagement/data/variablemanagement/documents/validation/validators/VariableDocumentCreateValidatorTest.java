 ...
 *
 */
public class VariableDocumentCreateValidatorTest extends AbstractWebTest {
  ...
  public void testValidateUniqueVariableAliasElementsFound() {
    ...
    assertThat(
        errors.getFieldError(VariableDocument.NESTED_VARIABLE_SURVEY_VARIABLE_ALIAS_FIELD.getNestedPath())
            .getCode(),
