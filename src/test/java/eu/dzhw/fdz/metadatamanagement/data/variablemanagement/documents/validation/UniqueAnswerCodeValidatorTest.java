 ...
 *
 */
public class UniqueAnswerCodeValidatorTest extends AbstractTest {
  ...
  public void testInvalidAnswerCode() {
    ...
    assertThat(errors.getFieldError(VariableDocument.ANSWER_OPTIONS_FIELD.getAbsolutePath()).getCode(),
        is("UniqueAnswerCode"));
  }
}
