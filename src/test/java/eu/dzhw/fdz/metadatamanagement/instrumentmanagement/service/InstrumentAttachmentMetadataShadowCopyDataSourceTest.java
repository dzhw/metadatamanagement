...
public class InstrumentAttachmentMetadataShadowCopyDataSourceTest extends AbstractTest {
  ...
  public void createShadowCopy() throws Exception {
    ...
    assertThat(metaData.getId(), equalTo("/public/files/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.0/attachments/filename.txt"));
    assertThat(metaData.getDataAcquisitionProjectId(), equalTo(PROJECT_ID + "-1.0.0"));
    assertThat(metaData.isShadow(), equalTo(true));
    assertThat(gridFsFile.getFilename(), equalTo("/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.0/attachments/filename.txt"));
    ...
    GridFSDBFile shadowCopy = gridFs.findOne("/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.0/attachments/filename.txt");
  ...
  public void createShadowCopyWithSameReleaseVersion() throws Exception {
    ...
    Query shadowQuery = new Query(GridFsCriteria.whereFilename().is("/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.0/attachments/filename.txt"));
  ...
  public void createShadowCopyLinkPredecessorToSuccessor() throws Exception {
    ...
    assertThat(metadata, notNullValue());
    assertThat(metadata.getSuccessorId(), equalTo("/public/files/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.1/attachments/filename.txt"));
    ...
    GridFSDBFile predecessor = gridFs.findOne("/instruments/ins-" + PROJECT_ID + "-ins1$-1.0.0/attachments/filename.txt");
  ...
  private InstrumentAttachmentMetadata createShadow(InstrumentAttachmentMetadata master, String version) {
  ...
  private void createTestFileForAttachment(InstrumentAttachmentMetadata metadata)
      throws Exception {
