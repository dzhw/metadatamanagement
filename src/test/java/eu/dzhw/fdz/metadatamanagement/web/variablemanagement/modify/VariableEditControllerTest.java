...
public class VariableEditControllerTest extends AbstractWebTest {
  ...
  public void testPostValidateInvalidVariableDocument() throws Exception {
    ...
    MvcResult mvcResult =
        this.mockMvc
            .perform(
                post("/de/variables/testPostInvalidateValidID007/edit/validate")
                    .param(VariableDocument.ID_FIELD.getAbsolutePath(),
                        "testPostInvalidateValidID007")
    ...
    // No W3C Validation Check, because return value is json.
  ...
  public void testPostValidateValidVariableDocument() throws Exception {
    ...
    MvcResult mvcResult =
        this.mockMvc
            .perform(
                post("/de/variables/testPostValidateValidID007/edit/validate")
                    .param(VariableDocument.ID_FIELD.getAbsolutePath(),
