...
public class DataSetAttachmentMetadataShadowCopyDataSourceTest extends AbstractTest {
  ...
  public void createShadowCopy() throws Exception {
    ...
    assertThat(metaData.getId(), equalTo("/public/files/data-sets/dat-" + PROJECT_ID + "-ds1$-1.0.0/attachments/filename.txt"));
    assertThat(metaData.getDataAcquisitionProjectId(), equalTo(PROJECT_ID + "-1.0.0"));
    assertThat(metaData.isShadow(), equalTo(true));
    assertThat(gridFsFile.getFilename(), equalTo("/data-sets/dat-" + PROJECT_ID + "-ds1$-1.0.0/attachments/filename.txt"));
  ...
  public void createShadowCopyWithSameReleaseVersion() throws Exception {
    ...
    Query shadowQuery = new Query(GridFsCriteria.whereFilename().is("/data-sets/dat-" + PROJECT_ID + "-ds1$-1.0.0/attachments/filename.txt"));
  ...
  public void createShadowCopyLinkPredecessorToSuccessor() throws Exception {
    ...
    assertThat(metadata, notNullValue());
    assertThat(metadata.getSuccessorId(), equalTo("/public/files/data-sets/dat-" + PROJECT_ID + "-ds1$-1.0.1/attachments/filename.txt"));
  ...
  private void createTestFileForAttachment(DataSetAttachmentMetadata metadata)
      throws Exception {
