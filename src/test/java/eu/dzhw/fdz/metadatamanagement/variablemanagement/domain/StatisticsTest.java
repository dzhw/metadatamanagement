...
public class StatisticsTest {
  ...
  public void testToString() {
    ...
    assertThat(toString, is(
        "Statistics(meanValue=87.5, minimum=0.0, maximum=140.0, skewness=123.0, kurtosis=234.0, median=90.0, standardDeviation=40.0, firstQuartile=70.0, thirdQuartile=110.0, mode=Mode, deviance=12.4, meanDeviation=58.7)"));
