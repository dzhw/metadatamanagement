...
public class UnitTestImageHelper {
   ...
   */
  public static void saveQuestionImage(QuestionImageService questionImageService, 
    ...
    try (InputStream inputStream = new BufferedInputStream(new FileInputStream(PATH_QUESTION_IMAGE))) {
      ...
      questionImageService.saveQuestionImage(multipartFile, questionImageMetadata);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public static void deleteQuestionImage(QuestionImageService questionImageService, String questionId) {
    questionImageService.deleteQuestionImages(questionId);
  }
