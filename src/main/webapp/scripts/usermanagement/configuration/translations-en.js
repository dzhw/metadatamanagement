  ...
  function($translateProvider) {
    var translations = {
      ...
      'user-management': {
        ...
        'welcome-dialog': {
          'title': 'Welcome',
          'text-body': '<p>Dear {{username}},</p><p>we are pleased that you have decided to make your research data available to other researchers via our FDZ. This system collects and publishes all information related to your research data (so-called metadata).</p><p>A detailed user documentation can be found here: <a href="https://metadatamanagement.readthedocs.io/de/stable/metadatenabgabe.html" target="_blank">ReadTheDocs</a>.</p>In the navigation menu on the left side you will find a list of all data acquisition projects to which you have been assigned as a data provider.</p><img src="/assets/images/welcome-dialog-project-chooser-{{language}}.png" class="fdz-welcome-dialog-image"/><p style="margin:10px 0px 0px 0px;">Simply select the project for which you want to provide metadata and click on the orange button <img src="/assets/images/welcome-dialog-project-cockpit-button.png"/> below the selected project.</p><p>As soon as the project is <img src="/assets/images/welcome-dialog-assigned-{{language}}.png" alt="Assigned to Data Providers"/>, you can start to enter Metadata.</p>',
