      ...
      'instrument-management': {
        ...
        'error': {
          ...
          'post-validation': {
            ...
            'instrument-unknown': 'The instrument {{id}} could not be found. It is referenced to the related publication ({{toBereferenzedId}}).',
            'instrument-has-not-a-referenced-study': 'The instrument {{id}} has a reference to the Study ({{additionalId}}). This Study is not refereced by the related publication ({{toBereferenzedId}}).'
          }
        }
      }
      //jscs:enable
