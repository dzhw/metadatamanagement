    ...
    var translations = {
      ...
      'shopping-cart': {
        ...
        'detail': {
          ...
          'note': 'The ordering system for data packages is currently being revised. In case you have problems with the ordering process, please contact <a href="mailto:dataservice@dzhw.eu">dataservice@dzhw.eu</a>.'
        },
        'error': {
