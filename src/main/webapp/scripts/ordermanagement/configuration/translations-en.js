    ...
    var translations = {
      ...
      'shopping-cart': {
        ...
        'detail': {
          ...
          'explain-data-product': 'A data package contains all data sets of a given study which have been prepared for the given access way (download, on-site, remote,...). You can request several data packages as well as the same study several times with different access ways.',
