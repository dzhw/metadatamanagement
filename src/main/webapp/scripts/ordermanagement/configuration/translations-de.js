    ...
    var translations = {
      ...
      'shopping-cart': {
        ...
        'detail': {
          ...
          'explain-data-product': 'Ein Datenpaket beinhaltet immer alle Datensätze einer Studie, die für den gewählten Zugangsweg (download, on-site, remote,...) aufbereitet wurden. Sie können sowohl mehrere Datenpakete, als auch dieselbe Studie mehrmals mit unterschiedlichen Zugangswegen beantragen.',
