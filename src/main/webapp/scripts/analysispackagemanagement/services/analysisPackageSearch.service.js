...
angular.module('metadatamanagementApp').factory('AnalysisPackageSearchService',
  function($q, ElasticSearchClient, CleanJSObjectService, SearchHelperService,
    ...
    var createTermFilters = function(filter, dataAcquisitionProjectId, type) {
      ...
      //   var analysisPackageId = AnalysisPackageIdBuilderService.buildAnalysisPackageId(
      //     dataAcquisitionProjectId);
      //   var analysisPackageFilter = {
      //     term: {
      //       'dataPackages.id': analysisPackageId
      //     }
      //   };
