    ...
    var translations = {
      ...
      'concept-management': {
        ...
        'edit': {
          ...
          'not-authorized-toast': 'Sie sind nicht berechtigt Konzepte zu bearbeiten oder anzulegen! Wenden Sie sich an eine Publisher:in dieses Projektes.<br><br>Bereits vorhandene Konzepte können Sie direkt in Ihren Instrumenten oder Fragen verwenden!',
