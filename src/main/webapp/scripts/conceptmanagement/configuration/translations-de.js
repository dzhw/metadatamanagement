    ...
    var translations = {
      ...
      'concept-management': {
        'detail': {
          ...
          'tooltips': {
            'surveys': {
              'one': 'Klicken, um die Erhebung, in der dieses Konzept verwendet wurde, anzuzeigen',
              'many': 'Klicken, um alle Erhebungen, in denen dieses Konzept verwendet wurde, anzuzeigen'
            },
            'data-sets': {
