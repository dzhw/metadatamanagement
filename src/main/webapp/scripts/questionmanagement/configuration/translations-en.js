  ...
  function($translateProvider) {
    var translations = {
      ...
      'question-management': {
        ...
        'error': {
          'question': {
            'valid-question-id-name': 'The RDC-ID of the Question is not valid for the Pattern: InstrumentID-QuestionNumber.',
          ...
          'post-validation': {
            ...
            'question-unknown': 'The Question {{id}} could not be found. It is referenced to the related publication ({{toBereferenzedId}}).',
            'question-has-not-a-referenced-study': 'The Question {{id}} has a reference to the Study ({{additionalId}}). This Study is not refereced by the related publication ({{toBereferenzedId}}).'
          }
        }
      }
      //jscs:enable
