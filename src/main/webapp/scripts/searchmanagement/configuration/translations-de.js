    ...
    var searchTranslations = {
      ...
      'search-management': {
        ...
        'delete-messages': {
          ...
          'delete-data-packages': 'Sind Sie sicher, dass Sie das Datenpaket des Datenaufbereitungsprojekts mit der FDZ-ID "{{ id }}" mit den übergebenen Daten ersetzen möchten?',
        ...
        'detail': {
          ...
          'related-publications-info': 'Publikationen enthalten bibliografische Informationen zu Veröffentlichungen, die die referenzierten Daten- und Analysepakete verwenden'
        },
        'buttons': {
