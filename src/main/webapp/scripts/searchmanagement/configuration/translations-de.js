    ...
    var searchTranslations = {
      ...
      'search-management': {
        ...
        'buttons': {
          ...
          'upload-or-create-instruments-tooltip': 'Alle Instrumente hochladen oder ein Instrument manuell erstellen',
          'upload-or-create-data-sets-tooltip': 'Alle Datensätze hochladen oder einen Datensatz manuell erstellen',
          ...
          'create-instrument-tooltip': 'Klicken, um ein neues Instrument manuell zu erstellen',
          'edit-instrument-tooltip': 'Klicken, um das Instrument manuell zu bearbeiten',
          'delete-instrument-tooltip': 'Klicken, um das Instrument zu löschen',
          'create-data-set-tooltip': 'Klicken, um einen neuen Datensatz manuell zu erstellen',
          'edit-data-set-tooltip': 'Klicken, um den Datensatz manuell zu bearbeiten',
