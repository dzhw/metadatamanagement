    ...
    var searchTranslations = {
      ...
      'search-management': {
        ...
        'filter': {
          ...
          'floating-label': {
            'survey': 'In which survey do you want to search?',
            'instrument': 'In which instrument do you to search?',
            'study': 'In which study do you want to search?',
            'data-set': 'In which data set do you want to search?',
            'related-publication': 'In which publication the data should have been used?',
            'panel-identifier': 'Which panel identifier of the variables?',
            'derived-variables-identifier': 'Which derived variables do you want to search?',
            'access-way': 'Which access way should be available?',
            'variable': 'Which variable is supposed to be included?',
            'question': 'Which question is supposed to be included?',
            'survey-series': 'In which survey series do you want to search?',
          },
          'input-label': {
