    ...
    var searchTranslations = {
      ...
      'search-management': {
        ...
        'buttons': {
          ...
          'upload-or-create-instruments-tooltip': 'Upload all instruments or manually create one instrument',
          'upload-or-create-data-sets-tooltip': 'Upload all data sets or manually create one data set',
          ...
          'create-instrument-tooltip': 'Click to manually create a new instrument',
          'edit-instrument-tooltip': 'Click to manually edit the instrument',
          'delete-instrument-tooltip': 'Click to delete the instrument',
          'create-data-set-tooltip': 'Click to manually create a new data set',
          'edit-data-set-tooltip': 'Click to manually edit the data set',
