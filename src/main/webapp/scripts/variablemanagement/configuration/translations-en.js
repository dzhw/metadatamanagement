      ...
      'variable-management': {
        ...
        'error': {
          ...
          'post-validation': {
            ...
            'question-unknown': 'The Variable {{id}} could not be found. It is referenced to the related publication ({{toBereferenzedId}}).',
            'question-has-not-a-referenced-study': 'The Variable {{id}} has a reference to the Study ({{additionalId}}). This Study is not refereced by the related publication ({{toBereferenzedId}}).'
          }
        }
      }
      //jscs:enable
