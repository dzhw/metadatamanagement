      ...
      'variable-management': {
        ...
        'error': {
          ...
          'variable': {
            ...
            'mandatory-scale-level-for-numeric-data-type': 'The scale level of a numeric or date variable must not be empty. However, it must be empty for string variables!',
