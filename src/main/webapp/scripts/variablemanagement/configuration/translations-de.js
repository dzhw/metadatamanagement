      ...
      'variable-management': {
        ...
        'error': {
          ...
          'variable': {
            ...
            'statistics-median-must-be-an-iso-date-on-date-data-type': 'Wenn der Datentyp einer Variable ein Datum ist, muss der Median von den Statistiken dem ISO Standard 8601 entsprechen.',
            'statistics-first-quartile-must-be-an-iso-date-on-date-data-type': 'Wenn der Datentyp einer Variable ein Datum ist, muss das erste Quartile von den Statistiken dem ISO Standard 8601 entsprechen.',
            'statistics-third-quartile-must-be-an-iso-date-on-date-data-type': 'Wenn der Datentyp einer Variable ein Datum ist, muss das dritte Quartile von den Statistiken dem ISO Standard 8601 entsprechen.',
            'id': {
