  ...
  function($translateProvider) {
    var translations = {
      ...
      'disclosure': {
        ...
        'copyright': 'Copyright: ',
        'copyright-general': 'Unless otherwise stated, copyright and all other rights for the internet pages of the Deutsches Zentrum für Hochschul- und Wissenschaftsforschung under <a id="externalLink" href="#!/en/">https://metadata.fdz.dzhw.eu/</a> lie with the DZHW. Further use and passing on of content, even in excerpts, for pedagogical, scientific or private use is allowed within the scope of the proper citation of the source. Permission must first be obtained for the use of copyright material in commercial business.',
