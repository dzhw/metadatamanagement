...
/**
 * The aggregation result mapper is a sub class from the {@link AggregationResultMapper}. It extends
 * the MapResuts method for saving the aggregations. It uses the JacksonDocumentMapper for mapping
 * e.g. LocalDate Object from Strings. In difference to the {@link AggregationResultMapper} it
 * support specific order of scale level or other filter buckets, which are different from the
 * docCount sorting.
 * 
 * @author Daniel Katzberg
 *
 */
public class VariableDocumentAggregrationResultMapper extends AggregationResultMapper {
