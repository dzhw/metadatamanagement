...
public class I18nConfiguration extends WebMvcConfigurerAdapter {
    ...
    /**
     * Add a cookie locale resolver which determines the users current language
     * by looking into a cookie if present. If not present it will determine the
     * current locale from the accept header.
     * 
    ...
    /**
     * Intercept get requests with url param "locale=de_DE" for instance to
     * change the cookie.
     * 
