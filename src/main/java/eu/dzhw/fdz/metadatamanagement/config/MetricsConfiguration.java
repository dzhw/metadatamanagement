...
/**
 * A configuration collection for metrics.
 *
 */
@Configuration
...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
  ...
  /**
   * A local class for the graphite registry.
   *
   */
  @Configuration
  ...
  /**
   * A local class for the spark registry.
   *
   */
  @Configuration
    ...
    private void init() {
      if (jhipsterProperties.getMetrics().getSpark().isEnabled()) {
        ...
        SparkReporter sparkReporter =
            SparkReporter.forRegistry(metricRegistry).convertRatesTo(TimeUnit.SECONDS)
