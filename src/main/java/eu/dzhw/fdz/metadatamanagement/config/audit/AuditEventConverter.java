...
/**
 * This converter is for the conversion of audit events. It converts audit events to and from the
 * persist representation to a audit event representation at the service layer.
 * 
