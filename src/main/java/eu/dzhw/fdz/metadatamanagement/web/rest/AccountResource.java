...
public class AccountResource {
   ...
   * 
   * @param mail a representation of a mail
   * @param request a representation of a request (in this case the password reset)
  ...
  /**
   * This method finishes a password reset.
   * 
   * @param keyAndPassword The key and the new password.
   * @return a response entity
   */
